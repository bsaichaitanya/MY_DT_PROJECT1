					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<c:forEach items="${category.products}" var="product">
								<li><a
									href="<c:url value="viewProduct/${product.pro_id}"/>">${product.pro_name}</a></li>
							</c:forEach>
						</ul></li>
				</c:forEach>
			...
			<c:if test="${(carousel==true)}">
				...
				<header id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						...
						<div class="item active">
							...
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\diw.gif" alt="#"
									width="100%" height="75%">
							</div>
						</div>
						...
						<div class="item ">
							...
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\a.gif" alt="#" width="100%"
									height="75%">
							</div>
						</div>
						...
						<div class="item ">
							<!-- Set the first background image using inline CSS below. -->
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\di4.jpg" alt="#"
									width="100%" height="75%">
							</div>
						</div>
						...
						<div class="item">
							...
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\yes.PNG" alt="#"
									width="100%" height="75%">
							</div>
						...
						<div class="item ">
							<!-- Set the first background image using inline CSS below. -->
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\ama.jpg" alt="#"
									width="100%" height="75%">
							</div>
						</div>
						<div class="item">
							<!-- Set the second background image using inline CSS below.  -->
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\2016.jpg" alt="#"
									width="100%" height="75%">
							</div>
  			...
  			<div class="fill"> <img  src="E:\PROJECT 1\pics\carousel\di3.PNG"alt="#" width="100%"
						...
						<div class="item">
							...
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\di3.PNG" alt="#"
									width="100%" height="75%">
							</div>
						</div>
						...
						<div class="item">
							...
							<div class="fill">
								<img src="E:\PROJECT 1\pics\carousel\Raksh.jpg" alt="#"
									width="100%" height="75%">
							</div>
						</div>
				...
				<div class="col-md-3 col-sm-6 hero-feature">
					<div class="thumbnail">
						<img alt="${product.pro_id}"
							src="<c:url value="E:\\workspace\\ShoppingCartFrontEnd\\src\\main\\resources\\images\\${product.pro_id}.jpg" ></c:url>"
							width="800px" height="500px" />
						<div class="caption">

							<h4>${product.pro_name}</h4>
							<h5><i>Rs.${product.pro_price}</i></h5>
							<p>${product.pro_description}</p>
							<p>
								<a href="#" class="btn btn-primary">Buy Now!</a> 
								<a href="<c:url value="viewProduct/${product.pro_id}" />" class="btn btn-success">More Info</a>
							</p>
						</div>
					</div>
				</div>
