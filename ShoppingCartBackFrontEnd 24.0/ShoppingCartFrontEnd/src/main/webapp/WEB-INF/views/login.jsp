			      ...
			      <c:if test="${not empty error}">
					...
					<div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                       	<input  name="j_username" type="text" pattern=".{5,15}" class="form-control" required="true"  placeholder="PLEASE ENTER YOUR USER ID"  />
                      </div>
					</div>
					...
					<div style="margin-bottom: 25px" class="input-group">
                                        	...
                                        	<input type="password"  pattern=".{4,15}" name="j_password" class="form-control" placeholder="PLEASE ENTER YOUR PASSWORD" required="true"   />
                                    </div>
						</div>
